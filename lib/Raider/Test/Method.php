...
@trigger_error('The Raider_Test_Method class is deprecated since version 1.12 and will be removed in 2.0. Use \Twig\TwigTest instead.', \E_USER_DEPRECATED);
 ...
 */
class Raider_Test_Method extends Raider_Test
{
    protected $extension;
    protected $method;

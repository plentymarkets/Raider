...
{
    public function __construct($capture, \Raider_NodeInterface $names, \Raider_NodeInterface $values, $lineno, $tag = null)
    {
...
class_alias('Raider\Node\SetNode', 'Raider_Node_Set');
